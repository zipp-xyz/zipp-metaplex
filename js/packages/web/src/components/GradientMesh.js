      ...
      >
        <defs>
          <radialGradient id="rg0" fx="0.33659108076628175" fy="0.5">
            <stop offset="0%" stopColor="#2BFF88"></stop>
            <stop offset="100%" stopColor="#2BFF88" stopOpacity="0"></stop>
            <Animate />
          </radialGradient>
          <radialGradient id="rg1" fx="0.3087221818808073" fy="0.5">
            <stop offset="0%" stopColor="#2BD2FF"></stop>
            <stop offset="100%" stopColor="#2BD2FF" stopOpacity="0"></stop>
            <Animate />
          </radialGradient>
          <radialGradient id="rg2" fx="0.36701211593031036" fy="0.5">
            <stop offset="0%" stopColor="#FA8BFF"></stop>
            <stop offset="100%" stopColor="#FA8BFF" stopOpacity="0"></stop>
            <Animate />
          </radialGradient>
