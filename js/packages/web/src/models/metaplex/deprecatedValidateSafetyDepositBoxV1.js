...
async function deprecatedValidateSafetyDepositBoxV1(vault, metadata, safetyDepositBox, safetyDepositTokenStore, tokenMint, auctionManagerAuthority, metadataAuthority, payer, instructions, edition, whitelistedCreator, store, printingMint, printingMintAuthority) {
    ...
    const keys = [
        {
            pubkey: (0, common_1.toPublicKey)(await (0, deprecatedStates_1.getSafetyDepositBoxValidationTicket)(auctionManagerKey, safetyDepositBox)),
            isSigner: false,
            isWritable: true,
        },
        {
        ...
        {
            pubkey: (0, common_1.toPublicKey)(originalAuthorityLookup),
            isSigner: false,
            isWritable: true,
        },
        {
            pubkey: (0, common_1.toPublicKey)(whitelistedCreator || web3_js_1.SystemProgram.programId),
            isSigner: false,
            isWritable: false,
        },
        {
            pubkey: (0, common_1.toPublicKey)(store),
            isSigner: false,
            isWritable: false,
        },
        {
            pubkey: (0, common_1.toPublicKey)(safetyDepositBox),
            isSigner: false,
            isWritable: false,
        },
        {
        ...
        {
            pubkey: (0, common_1.toPublicKey)(tokenMint),
            isSigner: false,
            isWritable: false,
        },
        {
            pubkey: (0, common_1.toPublicKey)(edition),
            isSigner: false,
            isWritable: false,
        },
        {
        ...
        {
            pubkey: (0, common_1.toPublicKey)(auctionManagerAuthority),
            isSigner: true,
            isWritable: false,
        },
        {
            pubkey: (0, common_1.toPublicKey)(metadataAuthority),
            isSigner: true,
            isWritable: false,
        },
        {
    ...
    if (printingMint && printingMintAuthority) {
        keys.push({
            pubkey: (0, common_1.toPublicKey)(printingMint),
            isSigner: false,
            isWritable: true,
        });
        keys.push({
            pubkey: (0, common_1.toPublicKey)(printingMintAuthority),
            isSigner: true,
            isWritable: false,
        });
    }
