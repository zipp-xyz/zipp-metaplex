...
exports.getPayoutTicket = exports.getSafetyDepositConfig = exports.getAuctionWinnerTokenTypeTracker = exports.getPrizeTrackingTicket = exports.getWhitelistedCreator = exports.getOriginalAuthority = exports.getBidderKeys = void 0;
            ...
            return this.instance.info.settings.winningConfigs.map(w => {
                return w.items.map(it => {
                    ...
                    if (!metadata) {
                        ...
                        let masterEdition = masterEditionsByPrintingMint[(_b = boxes[it.safetyDepositBoxIndex]) === null || _b === void 0 ? void 0 : _b.info.tokenMint];
                        if (masterEdition) {
...
class SafetyDepositConfig {
    constructor(args) {
        ...
        if (args.directArgs) {
            ...
            let lengthOfArray = new bn_js_1.default(args.data.slice(44, 48), 'le');
            this.amountRanges = [];
            let offset = 48;
...
async function getAuctionManagerKey(vault, auctionKey) {
    ...
    return (await (0, common_1.findProgramAddress)([Buffer.from(exports.METAPLEX_PREFIX), (0, common_1.toPublicKey)(auctionKey).toBuffer()], (0, common_1.toPublicKey)(PROGRAM_IDS.metaplex)))[0];
}
...
async function getBidRedemption(auctionKey, bidMetadata) {
    const PROGRAM_IDS = (0, common_1.programIds)();
    return (await (0, common_1.findProgramAddress)([
        Buffer.from(exports.METAPLEX_PREFIX),
        (0, common_1.toPublicKey)(auctionKey).toBuffer(),
        (0, common_1.toPublicKey)(bidMetadata).toBuffer(),
    ], (0, common_1.toPublicKey)(PROGRAM_IDS.metaplex)))[0];
}
exports.getBidRedemption = getBidRedemption;
async function getBidderKeys(auctionKey, bidder) {
    const PROGRAM_IDS = (0, common_1.programIds)();
    const bidMetadata = (await (0, common_1.findProgramAddress)([
        Buffer.from(common_1.AUCTION_PREFIX),
        (0, common_1.toPublicKey)(PROGRAM_IDS.auction).toBuffer(),
        (0, common_1.toPublicKey)(auctionKey).toBuffer(),
        (0, common_1.toPublicKey)(bidder).toBuffer(),
...
async function getOriginalAuthority(auctionKey, metadata) {
    ...
    return (await (0, common_1.findProgramAddress)([
        Buffer.from(exports.METAPLEX_PREFIX),
        (0, common_1.toPublicKey)(auctionKey).toBuffer(),
        (0, common_1.toPublicKey)(metadata).toBuffer(),
    ], (0, common_1.toPublicKey)(PROGRAM_IDS.metaplex)))[0];
}
...
async function getWhitelistedCreator(creator) {
    ...
    return (await (0, common_1.findProgramAddress)([
        Buffer.from(exports.METAPLEX_PREFIX),
        (0, common_1.toPublicKey)(PROGRAM_IDS.metaplex).toBuffer(),
        (0, common_1.toPublicKey)(store).toBuffer(),
        (0, common_1.toPublicKey)(creator).toBuffer(),
    ], (0, common_1.toPublicKey)(PROGRAM_IDS.metaplex)))[0];
}
...
async function getPrizeTrackingTicket(auctionManager, mint) {
    ...
    return (await (0, common_1.findProgramAddress)([
        Buffer.from(exports.METAPLEX_PREFIX),
        (0, common_1.toPublicKey)(PROGRAM_IDS.metaplex).toBuffer(),
        (0, common_1.toPublicKey)(auctionManager).toBuffer(),
        (0, common_1.toPublicKey)(mint).toBuffer(),
    ], (0, common_1.toPublicKey)(PROGRAM_IDS.metaplex)))[0];
}
...
async function getSafetyDepositConfig(auctionManager, safetyDeposit) {
    ...
    return (await (0, common_1.findProgramAddress)([
        ...
        (0, common_1.toPublicKey)(PROGRAM_IDS.metaplex).toBuffer(),
        (0, common_1.toPublicKey)(auctionManager).toBuffer(),
        (0, common_1.toPublicKey)(safetyDeposit).toBuffer(),
    ], (0, common_1.toPublicKey)(PROGRAM_IDS.metaplex)))[0];
}
...
async function getPayoutTicket(auctionManager, winnerConfigIndex, winnerConfigItemIndex, creatorIndex, safetyDepositBox, recipient) {
    ...
    return (await (0, common_1.findProgramAddress)([
        ...
        Buffer.from(creatorIndex !== null && creatorIndex !== undefined
            ...
            : 'auctioneer'),
        (0, common_1.toPublicKey)(safetyDepositBox).toBuffer(),
        (0, common_1.toPublicKey)(recipient).toBuffer(),
    ], (0, common_1.toPublicKey)(PROGRAM_IDS.metaplex)))[0];
}
