...
async function deprecatedValidateParticipation(auctionManager, openEditionMetadata, openEditionMasterAccount, printingAuthorizationHoldingAccount, auctionManagerAuthority, whitelistedCreatorEntry, store, safetyDepositBox, safetyDepositBoxTokenStore, vault, instructions) {
    ...
    const keys = [
        {
            pubkey: (0, common_1.toPublicKey)(auctionManager),
            isSigner: false,
            isWritable: true,
        },
        {
            pubkey: (0, common_1.toPublicKey)(openEditionMetadata),
            isSigner: false,
            isWritable: false,
        },
        {
            pubkey: (0, common_1.toPublicKey)(openEditionMasterAccount),
            isSigner: false,
            isWritable: false,
        },
        {
            pubkey: (0, common_1.toPublicKey)(printingAuthorizationHoldingAccount),
            isSigner: false,
            isWritable: false,
        },
        {
        ...
        {
            pubkey: (0, common_1.toPublicKey)(whitelistedCreatorEntry || web3_js_1.SystemProgram.programId),
            isSigner: false,
            isWritable: false,
        },
        {
        ...
        {
            pubkey: (0, common_1.toPublicKey)(safetyDepositBoxTokenStore),
            isSigner: false,
            isWritable: false,
        },
        {
