...
async function redeemParticipationBidV3(vault, safetyDepositTokenStore, destination, safetyDeposit, bidder, payer, metadata, masterEdition, originalMint, transferAuthority, acceptPaymentAccount, tokenPaymentAccount, newMint, edition, winIndex, instructions) {
    ...
    const auctionDataExtended = await (0, common_1.getAuctionExtended)({
    ...
    const newMetadata = await (0, common_1.getMetadata)(newMint);
    const newEdition = await (0, common_1.getEdition)(newMint);
    const editionMarkPda = await (0, common_1.getEditionMarkPda)(originalMint, edition);
    ...
    const keys = [
        ...
        {
            pubkey: (0, common_1.toPublicKey)(acceptPaymentAccount),
            isSigner: false,
            isWritable: true,
        },
        {
            pubkey: (0, common_1.toPublicKey)(tokenPaymentAccount),
            isSigner: false,
            isWritable: true,
        },
        {
            pubkey: (0, common_1.toPublicKey)(prizeTrackingTicket),
            isSigner: false,
            isWritable: true,
        },
        {
            pubkey: (0, common_1.toPublicKey)(newMetadata),
            isSigner: false,
            isWritable: true,
        },
        {
            pubkey: (0, common_1.toPublicKey)(newEdition),
            isSigner: false,
            isWritable: true,
        },
        {
            pubkey: (0, common_1.toPublicKey)(masterEdition),
            isSigner: false,
            isWritable: true,
        },
        {
            pubkey: (0, common_1.toPublicKey)(newMint),
            isSigner: false,
            isWritable: true,
        },
        {
            pubkey: (0, common_1.toPublicKey)(editionMarkPda),
            isSigner: false,
            isWritable: true,
        },
        {
        ...
        {
            pubkey: (0, common_1.toPublicKey)(metadata),
            isSigner: false,
            isWritable: false,
        },
        {
            pubkey: (0, common_1.toPublicKey)(auctionDataExtended),
            isSigner: false,
            isWritable: false,
        },
    ];
