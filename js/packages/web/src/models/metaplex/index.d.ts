import { AccountParser, AuctionData, ParsedAccount, Vault, Metadata, MasterEditionV1, SafetyDepositBox, MasterEditionV2, StringPublicKey } from '@oyster/common';
...
export declare function getWhitelistedCreator(creator: string): Promise<string>;
